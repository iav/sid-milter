...
#if WIN32
ifdef(`confNT', `APPENDDEF(`confINCDIRS', `-I${REL_SRC_DIR}/../nt-extensions/include -I${REL_SRC_DIR}/../pkgs/openldap/src/include -I${REL_SRC_DIR}/../pkgs/openldap/src/include/SMI-WIN32 -I${REL_SRC_DIR}/../nt-extensions')')
#endif /* WIN32 */
