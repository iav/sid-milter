...
#ifdef WIN32
# define E_WIN32BASE	(E_PSEUDOBASE + 1000)	/* base for win32 API errors */
#endif /* WIN32 */
...
# ifdef WIN32
extern const char *sm_win32_strerror(unsigned int win32_error);
#  define sm_win32_geterror() (GetLastError() + E_WIN32BASE)
# endif /* WIN32 */
