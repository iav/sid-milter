...
#  define GIT_T			int
#  define MODE_T		int
#  define SPT_TYPE		SPT_WIN32
#  define SFS_TYPE		SFS_NT
#  define LA_TYPE		LA_WIN32
#  define SM_INT32		long

/*
**  WARNING: ulgy hack ahead!
**	Since file permissions don't work here as sendmail expects it
**	(e.g., -rw-r--r-- has mode 100666 which screws up readqf())
**	the permission bits are set to 0 which essentially turns off
**	all file permission checks!
*/

/* get rid of compiler complaints due to redefinitions */
#  ifdef S_IWUSR
#   undef S_IWUSR
#  endif /* S_IWUSR */
#  ifdef S_IWGRP
...
#  define _PATH_SENDMAILCF	PATH_SENDMAILCF
#  define _PATH_SENDMAILPID	PATH_SENDMAILPID
#  ifdef MATCHGECOS
#   undef MATCHGECOS
#  endif /* MATCHGECOS */
#  define MATCHGECOS		0
...
# define SM_SET_H_ERRNO(err)		WSASetLastError((err))

#  if 0
#   pragma message( "  " __FILE__ "(2369) : Temporary disabled references to the BIND header files...." )
#  endif /* 0 */
# endif /* WIN32 */
